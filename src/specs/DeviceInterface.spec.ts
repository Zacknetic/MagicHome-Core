...
describe('Test the DeviceInterface class', () => {
    ...
    const commandOptions: ICommandOptions = { colorAssist: false, waitForResponse: true, maxRetries: 10, remainingRetries: 10, commandType: COLOR_COMMAND, timeoutMS: 50, isEightByteProtocol: true };
