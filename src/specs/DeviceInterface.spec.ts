...
// let deviceInterface;
// deviceInterface = new DeviceInterface('192.168.1.30');
...
//         let deviceCommand = { isOn: true, RGB: { red: 255, green: 0, blue: 0 }, CCT: { warmWhite: 0, coldWhite: 0 }, colorMask: 0xFF };
//         const commandOptions: ICommandOptions = { remainingRetries: 20, commandType: COLOR_COMMAND, timeoutMS: 0, isEightByteProtocol: false };
...
//         let deviceCommand = { isOn: true, RGB: { red: 0, green: 255, blue: 0 }, CCT: { warmWhite: 0, coldWhite: 0 }, colorMask: 0xFF };
//         const commandOptions: ICommandOptions = { remainingRetries: 20, commandType: COLOR_COMMAND, timeoutMS: 0, isEightByteProtocol: false };
...
//         let deviceCommand = { isOn: true, RGB: { red: 0, green: 0, blue: 255 }, CCT: { warmWhite: 0, coldWhite: 0 }, colorMask: 0xFF };
//         const commandOptions: ICommandOptions = { remainingRetries: 20, commandType: COLOR_COMMAND, timeoutMS: 0, isEightByteProtocol: false };
...
//         let deviceCommand = { isOn: true, RGB: { red: 0, green: 0, blue: 0 }, CCT: { warmWhite: 255, coldWhite: 0 }, colorMask: 0xFF };
//         const commandOptions: ICommandOptions = { remainingRetries: 20, commandType: COLOR_COMMAND, timeoutMS: 0, isEightByteProtocol: false };
